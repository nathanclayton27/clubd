...
**The last line is the most recent change to production.** Queued behind it,
written and not run: the club-progress migration and the CLU-153 pair — both
under *Queued and ready* below. *(This line used to say nothing was queued;
that stopped being true when club-progress was written.)*
